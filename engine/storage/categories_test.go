...
func TestIntegrationCategoryCanBeCreated(test *testing.T) {
	...
	createdCategory, err := storage.Categories.CreateCategory(categoryForCreate.Name)
	if err != nil {
		test.Error(err)
	}
	...
	existCategory, err := storage.Categories.CreateCategory(categoryForCreate.Name)
	if err != nil {
